...
// AccuWeather Today page for the locality that trailhead sits in.
//
...
// and kept here so nothing has to geocode at runtime. The AccuWeather page was
// looked up once too, by feeding each point to the site's own search in a
// browser (it refuses scripted requests) and taking the locality it landed on.
...
const accuweatherToday = (town, zip, locationKey) =>
	`https://www.accuweather.com/en/us/${town}/${zip}/weather-forecast/${locationKey}`;

const TRAILHEADS = {
	'austin-badger': { forecastUrl: accuweatherToday('medina', 44256, 335014), latitude: 41.1181, longitude: -81.8129 },
	'bedford-farley': {
		forecastUrl: accuweatherToday('walton-hills', 44146, 2190767),
		latitude: 41.3726,
		longitude: -81.5654
	},
	'bedford-olander': {
	...
	'big-creek': { forecastUrl: accuweatherToday('chardon', 44024, 335053), latitude: 41.6183, longitude: -81.2066 },
	'camp-tuscazoar': {
		forecastUrl: accuweatherToday('new-philadelphia', 44663, 335059),
		latitude: 40.5463,
		longitude: -81.3999
	},
	'cvnp-east-rim': {
		forecastUrl: accuweatherToday('boston-heights', 44236, 2238469),
		latitude: 41.2552,
		longitude: -81.5189
	},
	'hampton-hills': { forecastUrl: accuweatherToday('akron', 44308, 330119), latitude: 41.1512, longitude: -81.5507 },
	huffman: { forecastUrl: accuweatherToday('dayton', 45402, 330120), latitude: 39.8051, longitude: -84.0933 },
	'lake-milton': {
		forecastUrl: accuweatherToday('craig-beach', 44429, 2190967),
		latitude: 41.0564,
		longitude: -80.9674
	},
	mohican: { forecastUrl: accuweatherToday('loudonville', 44842, 2214984), latitude: 40.6081, longitude: -82.2581 },
	'oec-flow': {
		forecastUrl: accuweatherToday('cuyahoga-heights', 44125, 2115659),
		latitude: 41.4309,
		longitude: -81.6624
	},
	'oec-primitive': {
	...
	'quail-hollow': {
		forecastUrl: accuweatherToday('hartville', 44632, 2238767),
		latitude: 40.9768,
		longitude: -81.3104
	},
	'reagan-loop': { forecastUrl: accuweatherToday('medina', 44256, 335014), latitude: 41.1534, longitude: -81.8402 },
	'reagan-river': { forecastUrl: accuweatherToday('medina', 44256, 335014), latitude: 41.1554, longitude: -81.8319 },
	'royalview-red': {
		forecastUrl: accuweatherToday('strongsville', 44149, 2086719),
		latitude: 41.3108,
		longitude: -81.7936
	},
	'royalview-yellow': {
	...
	'thorn-ftp': { forecastUrl: accuweatherToday('wellington', 44090, 340044), latitude: 41.1384, longitude: -82.2142 },
	vulturesknob: { forecastUrl: accuweatherToday('wooster', 44691, 335050), latitude: 40.8509, longitude: -81.9804 },
	'west-branch': { forecastUrl: accuweatherToday('ravenna', 44266, 335063), latitude: 41.1322, longitude: -81.1422 },
	'west-creek': { forecastUrl: accuweatherToday('parma', 44129, 349939), latitude: 41.3881, longitude: -81.6942 }
};
